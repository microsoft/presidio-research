...
def test_compare_span_simple_case_1():
    ...
    expected_span_outputs = [SpanOutput(output_type="ENT_TYPE",
                                        annotated_span=annotated_spans[1],
                                        predicted_span=predicted_spans[1],
                                        overlap_score=0.82),
                             SpanOutput(output_type="EXACT",
                                        annotated_span=annotated_spans[2],
                                        predicted_span=predicted_spans[2],
                                        overlap_score=1),
                             SpanOutput(output_type="STRICT",
                                        annotated_span=annotated_spans[3],
                                        predicted_span=predicted_spans[3],
                                        overlap_score=1),
                             SpanOutput(output_type="STRICT",
                                        annotated_span=annotated_spans[4],
                                        predicted_span=predicted_spans[4],
                                        overlap_score=1),
                             SpanOutput(output_type="PARTIAL",
                                        annotated_span=annotated_spans[5],
                                        predicted_span=predicted_spans[5],
                                        overlap_score=0.71)]
