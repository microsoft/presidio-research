...
class BaseModel(ABC):
    def __init__(
        ...
        :param entity_mapping: Dictionary for mapping this model's input
        and output with the expected.
    ...
    def align_prediction_types(
        ...
        :param ignore_unknown: True if entity types not in entity_mapping
         should be translated to "O"
        :return: New tags
        """
