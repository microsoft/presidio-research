...
class Span:
    ...
    def intersect(self, other, ignore_entity_type: bool) -> int:
        """
    ...
    def get_overlap_ratio(self, other: "Span", ignore_entity_type: bool) -> float:
        """
        Calculates the ratio as: ratio = 2.0*M / T , where M = matches ,
        ...
        try:
            ...
            total_characters = (self.end_position - self.start_position) + (
                        other.end_position - other.start_position)
